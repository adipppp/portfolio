  ...
  return (
    ...
    >
      <div className="max-w-4xl mx-auto">
        ...
        <div 
          className="relative border-r mr-4 md:mr-6 space-y-12 text-right"
        ...
        >
          {education.map((edu, index) => (
            ...
            >
              ...
              <div 
                className="absolute -right-[6px] top-2.5 w-3 h-3 rounded-full transition-all duration-300 group-hover:scale-125"
                style={{
              ...
              <div 
                className="p-6 rounded-sm transition-all duration-300 text-left md:text-right"
                style={{
              ...
              >
                <div className="flex flex-col md:flex-row-reverse md:items-center justify-between gap-4 mb-4">
                  <div>
                    ...
                    <div 
                      className="flex items-center justify-end gap-2 font-mono text-sm font-semibold mt-1"
                  ...
                  <div 
                    className="flex flex-col text-xs font-mono md:items-start text-left gap-1"
